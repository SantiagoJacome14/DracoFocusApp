...
class LessonController extends Controller
{
    ...
    private function mapCorrectAnswer($question)
    {
        ...
        $index = array_search(strtoupper($question->correct_answer), $letters);
        ...
        return $options[$index] ?? $options[$letter] ?? $question->correct_answer;
    }
}
